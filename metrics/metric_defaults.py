...
metric_defaults = EasyDict([(args.name, args) for args in [
    #------------------------ watermark ------------------------
    EasyDict(name='fid_watermark_accuracy_30k',    func_name='metrics.frechet_inception_distance_watermark_accuracy.FID_watermark_accuracy', num_images=30000, minibatch_per_gpu=32),
    #------------------------ official original ------------------------
